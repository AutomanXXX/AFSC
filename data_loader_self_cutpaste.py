...
class MVTecDRAEMTrainDataset(Dataset):
    ...
    def randAugmenter(self):
        aug_ind = np.random.choice(np.arange(len(self.augmenters)), 2, replace=False)
    ...
    def augment_image(self, image, anomaly_source_path):
        ...
        # anomaly_source_img = self.rot(image=anomaly_source_img)
    ...
    def transform_image(self, image_path):
        ...
        if what_anomaly > 0.5:
            ...
            augmented_image, anomaly_mask, has_anomaly = self.augment_image(image, image_path)
