...
class EFCm(nn.Module):
    ...
    def forward(self, x):
        ...
        out = out_last * self.eca(out_last)
...
class DiscriminativeSubNetwork(nn.Module):
    ...
    def forward(self, x, len_dataloader, i_batch, epoch, fix_epoch, run_name):
        ...
        if (epoch + 1) < fix_epoch:  # m

            prob_mask_tensor1 = torch.sigmoid(self.slope1_1 * self.mult1)  # (1,256,256)
            ...
            prob_mask_tensor2 = torch.sigmoid(self.slope2_1 * self.mult2)  # (1,256,256)
            ...
            prob_mask_tensor3 = torch.sigmoid(self.slope3_1 * self.mult3)  # (1,256,256)
